...
1. Once it is uploaded, Navigate to the **Chat (1)** tab then provide the following prompt **(2)** then click **send (3)** button and then check how the response is generated by Copilot.
